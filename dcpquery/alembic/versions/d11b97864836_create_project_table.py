...
def upgrade():
    ...
    op.create_index(op.f('ix_project_file_join_table_file_fqid'), 'project_file_join_table', ['file_fqid'], unique=False)
    op.create_index(op.f('ix_project_file_join_table_project_fqid'), 'project_file_join_table', ['project_fqid'], unique=False)
    op.execute(
        """
