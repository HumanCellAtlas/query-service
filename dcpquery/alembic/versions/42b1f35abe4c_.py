...
Revision ID: 42b1f35abe4c
Revises: 000000000000
Create Date: 2019-12-08 13:22:08.426316
...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('accession_uuid', postgresql.UUID(), nullable=False),
    sa.Column('biomaterial_uuid', postgresql.UUID(), nullable=False),
    ...
    sa.Column('cell_size_unit_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['cell_size_unit_uuid'], ['ontologies.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
    ...
    sa.Column('project_role_uuid', postgresql.UUID(), nullable=True),
    sa.Column('user_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['project_role_uuid'], ['ontologies.uuid'], ),
    ...
    sa.Column('uuid', postgresql.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['uuid'], ['ontologies.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
    ...
    sa.Column('genus_species_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['genus_species_uuid'], ['ontologies.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('file_uuid', postgresql.UUID(), nullable=False),
    sa.Column('ontology_uuid', postgresql.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['file_uuid'], ['files.uuid'], ),
    sa.ForeignKeyConstraint(['ontology_uuid'], ['ontologies.uuid'], ),
    sa.PrimaryKeyConstraint('uuid', 'file_uuid', 'ontology_uuid')
    )
    ...
    sa.Column('age_unit_uuid', postgresql.UUID(), nullable=True),
    sa.Column('model_organ_uuid', postgresql.UUID(), nullable=True),
    sa.Column('genus_species_uuid', postgresql.UUID(), nullable=True),
    sa.Column('model_organ_part_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['age_unit_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['genus_species_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['model_organ_part_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['model_organ_uuid'], ['ontologies.uuid'], ),
    ...
    sa.Column('storage_time_unit_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['storage_time_unit_uuid'], ['ontologies.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
    ...
    sa.Column('accession_uuid', postgresql.UUID(), nullable=True),
    sa.Column('type_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['accession_uuid'], ['accessions.uuid'], ),
    sa.ForeignKeyConstraint(['type_uuid'], ['ontologies.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('project_uuid', postgresql.UUID(), nullable=False),
    sa.Column('access_group_uuid', postgresql.UUID(), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('project_uuid', postgresql.UUID(), nullable=False),
    sa.Column('accessions_uuid', postgresql.UUID(), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('project_uuid', postgresql.UUID(), nullable=False),
    sa.Column('funder_uuid', postgresql.UUID(), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('project_uuid', postgresql.UUID(), nullable=False),
    sa.Column('link_uuid', postgresql.UUID(), nullable=False),
    ...
    sa.Column('body', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('method_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['method_uuid'], ['ontologies.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
    ...
    sa.Column('url_uuid', postgresql.UUID(), nullable=True),
    ...
    sa.Column('unit_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['unit_uuid'], ['ontologies.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
    ...
    sa.Column('cell_morphology_uuid', postgresql.UUID(), nullable=True),
    sa.Column('growth_condition_uuid', postgresql.UUID(), nullable=True),
    sa.Column('time_course_uuid', postgresql.UUID(), nullable=True),
    sa.Column('cell_type_uuid', postgresql.UUID(), nullable=True),
    sa.Column('model_organ_uuid', postgresql.UUID(), nullable=True),
    sa.Column('cell_cycle_uuid', postgresql.UUID(), nullable=True),
    sa.Column('tissue_uuid', postgresql.UUID(), nullable=True),
    sa.Column('disease_uuid', postgresql.UUID(), nullable=True),
    sa.Column('genus_species_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['cell_cycle_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['cell_morphology_uuid'], ['cell_morphologies.uuid'], ),
    sa.ForeignKeyConstraint(['cell_type_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['disease_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['genus_species_uuid'], ['ontologies.uuid'], ),
    ...
    sa.ForeignKeyConstraint(['tissue_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['uuid'], ['biomaterials.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
    ...
    sa.Column('cell_morphology_uuid', postgresql.UUID(), nullable=True),
    sa.Column('genus_species_uuid', postgresql.UUID(), nullable=True),
    sa.Column('plate_based_sequencing_uuid', postgresql.UUID(), nullable=True),
    sa.Column('time_course_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['cell_morphology_uuid'], ['cell_morphologies.uuid'], ),
    sa.ForeignKeyConstraint(['genus_species_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['growth_condition_uuid'], ['growth_conditions.uuid'], ),
    ...
    sa.Column('cause_of_death_uuid', postgresql.UUID(), nullable=True),
    sa.Column('familial_relationship_uuid', postgresql.UUID(), nullable=True),
    sa.Column('medical_history_uuid', postgresql.UUID(), nullable=True),
    sa.Column('time_course_uuid', postgresql.UUID(), nullable=True),
    sa.Column('development_stage_uuid', postgresql.UUID(), nullable=True),
    sa.Column('strain_uuid', postgresql.UUID(), nullable=True),
    sa.Column('ethnicity_uuid', postgresql.UUID(), nullable=True),
    sa.Column('genus_species_uuid', postgresql.UUID(), nullable=True),
    sa.Column('organism_age_unit_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['cause_of_death_uuid'], ['causes_of_death.uuid'], ),
    sa.ForeignKeyConstraint(['development_stage_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['ethnicity_uuid'], ['ontologies.uuid'], ),
    ...
    sa.ForeignKeyConstraint(['organism_age_unit_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['strain_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['time_course_uuid'], ['time_courses.uuid'], ),
    sa.ForeignKeyConstraint(['uuid'], ['biomaterials.uuid'], ),
    sa.PrimaryKeyConstraint('uuid')
    )
    ...
    sa.Column('ipsc_induction_kit_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['protocols.uuid'], ),
    ...
    sa.Column('cell_barcode_uuid', postgresql.UUID(), nullable=True),
    sa.Column('umi_barcode_uuid', postgresql.UUID(), nullable=True),
    sa.Column('library_construction_kit_uuid', postgresql.UUID(), nullable=True),
    sa.Column('nucleic_acid_conversion_kit_uuid', postgresql.UUID(), nullable=True),
    sa.Column('spike_in_kit_uuid', postgresql.UUID(), nullable=True),
    sa.Column('cdna_library_amplification_method_uuid', postgresql.UUID(), nullable=True),
    sa.Column('library_preamplification_method_uuid', postgresql.UUID(), nullable=True),
    sa.Column('library_construction_method_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['cdna_library_amplification_method_uuid'], ['ontologies.uuid'], ),
    ...
    sa.ForeignKeyConstraint(['library_construction_method_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['library_preamplification_method_uuid'], ['ontologies.uuid'], ),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('process_uuid', postgresql.UUID(), nullable=False),
    sa.Column('parameter_uuid', postgresql.UUID(), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('connection_type', sa.Enum('INPUT', 'OUTPUT', 'PROTOCOL', name='processconnectiontypeenum'), nullable=True),
    sa.Column('protocol_uuid', postgresql.UUID(), nullable=False),
    sa.Column('process_uuid', postgresql.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['process_uuid'], ['processes.uuid'], ),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('parent_process_uuid', postgresql.UUID(), nullable=False),
    sa.Column('child_process_uuid', postgresql.UUID(), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('project_uuid', postgresql.UUID(), nullable=False),
    sa.Column('contributor_uuid', postgresql.UUID(), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('project_uuid', postgresql.UUID(), nullable=False),
    sa.Column('publication_uuid', postgresql.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['project_uuid'], ['projects.uuid'], ),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('protocol_uuid', postgresql.UUID(), nullable=False),
    sa.Column('reagent_uuid', postgresql.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['protocol_uuid'], ['protocols.uuid'], ),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('sequence_file_uuid', postgresql.UUID(), nullable=False),
    sa.Column('accession_uuid', postgresql.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['accession_uuid'], ['accessions.uuid'], ),
    ...
    sa.Column('ten_x_uuid', postgresql.UUID(), nullable=True),
    sa.Column('instrument_manufacturer_model_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['protocols.uuid'], ),
    sa.ForeignKeyConstraint(['instrument_manufacturer_model_uuid'], ['ontologies.uuid'], ),
    ...
    sa.Column('organ_uuid', postgresql.UUID(), nullable=True),
    sa.Column('genus_sepcies_uuid', postgresql.UUID(), nullable=True),
    sa.Column('organ_parts_uuid', postgresql.UUID(), nullable=True),
    sa.Column('preservation_storage_uuid', postgresql.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['genus_sepcies_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['organ_parts_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['organ_uuid'], ['ontologies.uuid'], ),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('cell_line_uuid', postgresql.UUID(), nullable=False),
    sa.Column('publication_uuid', postgresql.UUID(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('cell_suspension_uuid', postgresql.UUID(), nullable=False),
    sa.Column('cell_type_ontology_uuid', postgresql.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['cell_suspension_uuid'], ['cell_suspensions.uuid'], ),
    sa.ForeignKeyConstraint(['cell_type_ontology_uuid'], ['ontologies.uuid'], ),
    sa.PrimaryKeyConstraint('uuid', 'cell_suspension_uuid', 'cell_type_ontology_uuid')
    )
    ...
    sa.Column('barcode_uuid', postgresql.UUID(), nullable=True),
    sa.Column('sequence_file_uuid', postgresql.UUID(), nullable=True),
    sa.Column('cell_suspension_uuid', postgresql.UUID(), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('donor_organism_uuid', postgresql.UUID(), nullable=False),
    sa.Column('disease_ontology_uuid', postgresql.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['disease_ontology_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['donor_organism_uuid'], ['donor_organism.uuid'], ),
    sa.PrimaryKeyConstraint('uuid', 'donor_organism_uuid', 'disease_ontology_uuid')
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('specimen_uuid', postgresql.UUID(), nullable=False),
    sa.Column('disease_ontology_uuid', postgresql.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['disease_ontology_uuid'], ['ontologies.uuid'], ),
    sa.ForeignKeyConstraint(['specimen_uuid'], ['specimens.uuid'], ),
    sa.PrimaryKeyConstraint('uuid', 'specimen_uuid', 'disease_ontology_uuid')
    )
    ...
    sa.Column('cell_uuid', postgresql.UUID(), nullable=False),
    sa.Column('feature_uuid', postgresql.UUID(), nullable=False),
