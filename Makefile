...
prune:
	cd dist/deployment; rm -rf awscli* boto3* botocore* cryptography* swagger_ui_bundle/vendor/swagger-ui-2* swagger_ui_bundle/vendor/eh connexion/vendor/swagger-ui*
