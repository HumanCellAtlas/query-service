...
resource "aws_vpc" "vpc" {
  ...
  tags = {
    Name = "query-${var.deployment_stage}"
    component = "query"
...
resource "aws_subnet" "sn" {
  ...
  tags = {
    Name = "query-${var.deployment_stage}-${local.az_names[count.index]}"
    component = "query"
    deployment_stage = "${var.deployment_stage}"
  }
}
...
resource "aws_default_security_group" "sg" {
  ...
  tags = {
    Name = "query-${var.deployment_stage}-default"
    component = "query"
    deployment_stage = "${var.deployment_stage}"
  }
}
